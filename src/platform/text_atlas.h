...
void *create_font_atlas(void *device, void *queue, float font_size,
...
void draw_text_quad(void *frame_context, void *texture, float dst_x,
                    float dst_y, float dst_w, float dst_h, float uv_x,
                    float uv_y, float uv_w, float uv_h, float r, float g,
                    float b, float a);
